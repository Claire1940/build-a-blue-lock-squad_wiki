...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Build A Blue Lock Squad Wiki",
    description: "Read the Terms of Service for Build A Blue Lock Squad Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Build A Blue Lock Squad Wiki",
      description: "Terms and conditions for using Build A Blue Lock Squad Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Build A Blue Lock Squad Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Build A Blue Lock Squad Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Build A Blue Lock Squad Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Build A Blue Lock Squad Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game "Build A Blue Lock Squad". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Character guides and tier lists</li>
              <li>Squad build and formation guides</li>
              <li>Codes and rewards updates</li>
              <li>Gameplay and skill guides</li>
              <li>PvP duel strategies</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Build A Blue Lock Squad Wiki is NOT affiliated with, endorsed by, or associated with
              Roblox Corporation or the official developers of Build A Blue Lock Squad. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Build A Blue Lock Squad Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Roblox Corporation and/or the developers of Build A Blue Lock Squad. We use such
            ...
            <ul>
              ...
              <li><strong>Demo Availability:</strong> Roblox game updates and content may change without notice. We are not responsible for in-game changes or availability.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, BUILD A BLUE LOCK SQUAD WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Build A Blue Lock Squad Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@build-a-blue-lock-squad.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@build-a-blue-lock-squad.wiki</a>
            </p>
            <p>
