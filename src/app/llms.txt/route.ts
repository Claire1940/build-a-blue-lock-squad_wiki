...
export async function GET() {
  const baseUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.build-a-blue-lock-squad.wiki'
  const siteName = process.env.NEXT_PUBLIC_SITE_NAME || 'Build A Blue Lock Squad Wiki'
